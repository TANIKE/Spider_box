...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    else if(!strcmp(variable, "servo")) // 3250, 4875, 6500
    {
      ...
      ledcWrite(8,10*val);
      if(val>500) Serial.print("");
      else if (val<500) Serial.print("");
    }     
...
<html>
    ...
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <img id="stream" src="" style="transform: rotate(180deg);">
      </div>
    </figure>
        <section class="main">
            <section id="buttons">
                <table>
                <tr><td align="center"><button id="get-still">Get Still</button></td><td align="center"><button id="trans" onclick="fetch(document.location.origin+'/control?var=car&val=6');">Trans</button></td><td align="center"><button id="toggle-stream">Start Stream</button></td></tr>
                <tr><td align="center"><button id="turnleft" onclick="fetch(document.location.origin+'/control?var=car&val=7');">TurnLeft</button></td><td align="center"><button style="background-color:#C0C0C0" id="forward" onclick="fetch(document.location.origin+'/control?var=car&val=1');">Forward</button></td><td align="center"><button id="turnright" onclick="fetch(document.location.origin+'/control?var=car&val=8');">TurnRight</button></td></tr>
                <tr><td align="center"><button style="background-color:#C0C0C0" id="left" onclick="fetch(document.location.origin+'/control?var=car&val=2');">Left</button></td><td align="center"><button style="background-color:#C0C0C0" id="stop" onclick="fetch(document.location.origin+'/control?var=car&val=3');">Stop</button></td><td align="center"><button style="background-color:#C0C0C0" id="right" onclick="fetch(document.location.origin+'/control?var=car&val=4');">Right</button></td></tr>
                <tr><td></td><td align="center"><button style="background-color:#C0C0C0" id="backward" onclick="fetch(document.location.origin+'/control?var=car&val=5');">Backward</button></td><td></td></tr>
